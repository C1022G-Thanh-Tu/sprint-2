...
import {
  ...
  setCartsAction,
} from "../../redux/action/CartDetail/showList";
...
function ShoppingCart() {
  ...
  const { carts } = useSelector((state) => state.cartDetails);

  const total = (carts || []).reduce((acc, cart) => {
    return acc + cart.quantity * cart.productDTO.price;
  }, 0);
